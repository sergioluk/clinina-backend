...
public interface VendaRepository extends JpaRepository<Venda, Long> {
   ...
   //List<DadosItensVendidos> buscarItensVendidos();
    ...
    @Query(value = "SELECT v.id, v.peso, p.imagemP, p.produto, v.quantidade, v.preco_unitario as precoUnitario, v.preco_total as PrecoTotal, v.data FROM vendas v JOIN produtos p ON v.produto_id = p.id where data >= '2024-02-09 00:00:00' and data <= '2024-02-09 23:59:59';", nativeQuery = true)
    List<DadosItensVendidos> buscarItensVendidos();
